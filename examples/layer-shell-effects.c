...
main (int argc, char **argv)
{
  ...
  while ((c = getopt (argc, argv, "d:e:w:h:l:a:t:")) != -1) {
    switch (c) {
    case 'd':
      drag_margin = atoi (optarg);
      break;
    case 'e':
  ...
  zphoc_draggable_layer_surface_v1_set_margins (drag_surface, drag_margin, 0);
